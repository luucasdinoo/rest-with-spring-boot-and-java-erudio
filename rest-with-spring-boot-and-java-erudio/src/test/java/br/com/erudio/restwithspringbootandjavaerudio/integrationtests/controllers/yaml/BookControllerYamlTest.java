package br.com.erudio.restwithspringbootandjavaerudio.integrationtests.controllers.yaml;
...
import br.com.erudio.restwithspringbootandjavaerudio.integrationtests.dto.pagedmodels.PagedModelBook;
...
public class BookControllerYamlTest extends AbstractIntegrationTest {
    ...
    public void authorization() {
        AccountCredentialDto user = new AccountCredentialDto();
        ...
        var token =
                given()
                    .config(
                        RestAssuredConfig
                            ...
                            .encoderConfig(EncoderConfig.encoderConfig()
                                    .encodeContentTypeAs(TesteConfigs.CONTENT_TYPE_YML, ContentType.TEXT)))
                    ...
                    .extract()
                    .body()
                        .as(TokenDto.class, (ObjectMapper) objectMapper)
                    .getAccessToken();
    ...
    public void testCreate() throws JsonMappingException, JsonProcessingException {
        ...
        book = given()
                ...
                .contentType(TesteConfigs.CONTENT_TYPE_YML)
				.accept(TesteConfigs.CONTENT_TYPE_YML)
                    .body(book, (ObjectMapper) objectMapper)
                    .when()
                    .post()
                .then()
                    .statusCode(200)
                        .extract()
                        .body()
                            .as(BookDto.class, (ObjectMapper) objectMapper);
    ...
    public void testFindAll() throws JsonMappingException, JsonProcessingException {
        var response = given()
                ...
                .extract()
                    .body()
                    	.as(PagedModelBook.class, (ObjectMapper) objectMapper);
